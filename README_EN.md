...
![Code Generation Process](https://github.com/indexdoc/indexdoc-model-to-code/raw/main/codeGenerationProcess.png)
...
![Main Page](https://github.com/indexdoc/indexdoc-model-to-code/raw/main/mainPage.png)
### 2.2 "Data Type Mapping" Interface
![Data Type Mapping](https://github.com/indexdoc/indexdoc-model-to-code/raw/main/dataTypeMapping.png)
...
![Edit Template](https://github.com/indexdoc/indexdoc-model-to-code/raw/main/editTemplate.png)

CodeAsst supports template sets – a template set can include multiple templates (e.g., you can define a template set for Java programs and another for .NET programs).
...
![New Template](https://github.com/indexdoc/indexdoc-model-to-code/raw/main/newTemplate.png)
...
Template comments use `#*` and `*#` – content between these delimiters will be omitted during code generation.
```bash
...
#### 2.3.5 Template Sets
![Template Set](https://github.com/indexdoc/indexdoc-model-to-code/raw/main/templateSet.png)
#### 2.3.6 Template Content
Edit template content directly in CodeAsst or use your preferred text editor.
![Model Set](https://github.com/indexdoc/indexdoc-model-to-code/raw/main/modelSet.png)
### 2.4 "Open Data Model" Interface
![Open Data Model](https://github.com/indexdoc/indexdoc-model-to-code/raw/main/openDataModel.png)
#### 2.4.1 Open PDM File
...
![Connect Database](https://github.com/indexdoc/indexdoc-model-to-code/raw/main/connectDatabase.png)

Select a username and confirm – CodeAsst will read all table structure information under this user (may take several minutes).

![Choose Database](https://github.com/indexdoc/indexdoc-model-to-code/raw/main/choseDatabase.png)
...
![Choose Table Model](https://github.com/indexdoc/indexdoc-model-to-code/raw/main/choseTableModel.png)
### 2.6 Code Generation
With templates and data model confirmed, open the "Code Generation" interface.
![Code Produce](https://github.com/indexdoc/indexdoc-model-to-code/raw/main/codeProduce.png)

As shown, click the button in the red circle to set the output directory, then click "Generate Files" to create code files.

![Create Files](https://github.com/indexdoc/indexdoc-model-to-code/raw/main/createFlies.png)
...
Edit template content directly in CodeAsst or use your preferred text editor.
![Template Content](https://github.com/indexdoc/indexdoc-model-to-code/raw/main/templateContent.png)
